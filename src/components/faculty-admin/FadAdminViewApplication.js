...
function FadAdminViewApplication() {
  ...
  function rejectApplication() {
    client
      .post("/admin/fad/reject-promotion", {
        promotionId,
  ...
  function approveApplication() {
    client
      .post("/admin/fad/approve-application", { promotionId })
      .then((res) => {
        if (res.data.error) {
          if ("tokenError" in res.data) {
            navigate("/admin/login");
        ...
        <div className="contents">
          <div className="sub__header action__header">
            ...
            <div className="application__actions">
              ...
              {pageData.promotionData.status.includes("faculty approved") ||
              pageData.promotionData.status.includes("faculty rejected") ? (
                ""
              ) : (
                <React.Fragment>
                  <Chip
...
export default FadAdminViewApplication;
